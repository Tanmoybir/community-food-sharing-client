...
const AddFood = () => {
    ...
    const { mutate } = useMutation({
        mutationKey: ['addFood'],
        mutationFn: (addFood) => {
            return axios.post('/donator/foods',addFood)
        },
        onSuccess: () => {
            ...
            <div className="mt-5 px-3">
                <form className="max-w-[400px] md:max-w-lg lg:max-w-3xl w-full mx-auto bg-gray-900 p-8 px-8 rounded-lg">
                    ...
                    <input onClick={() => mutate({
                        ...
                        additional_notes,
                        donator})} 
                        className="w-full my-5 py-2 text-3xl bg-teal-500 shadow-teal-500/50 hover:shadow-teal-500/40 text-white font-semibold rounded-lg" type="button" value="ADD" />
